...
bool SurfPerchPlugin::initialise(size_t channels, size_t, size_t blockSize) {
...
size_t SurfPerchPlugin::getPreferredBlockSize() const { return 1024; }
size_t SurfPerchPlugin::getPreferredStepSize()  const { return 1024; }
